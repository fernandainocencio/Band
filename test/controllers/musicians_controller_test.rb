...
class MusiciansControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create musician" do
    assert_difference('Musician.count') do
      post musicians_url, params: { musician: { instrument: @musician.instrument, name: @musician.name } }
    end

    assert_redirected_to musician_path(Musician.last)
  end
  ...
  test "should update musician" do
    patch musician_url(@musician), params: { musician: { instrument: @musician.instrument, name: @musician.name } }
    assert_redirected_to musician_path(@musician)
  end
